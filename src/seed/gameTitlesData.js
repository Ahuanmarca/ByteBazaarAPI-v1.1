...
const gameTitlesData = [
  {
    ...
    genres: ['action', 'role'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['arcadian'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['strategy'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['simulation'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['musicalGames'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['platforms', 'graphicAdventure'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['terror'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['stealth'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['graphicAdventure'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['puzzle'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['sandbox'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['adventure', 'action'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['simulation', 'sports'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['arcadian', 'shooter'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['fight'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['racing'].map((g) => genresMap[g]),
  },
  {
    ...
    genres: ['shooter'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['adventure'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['sports'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['tableGames', 'strategy'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['platforms'].map((g) => genresMap[g]),
  },
  {
  ...
  },
  {
    ...
    genres: ['action'].map((g) => genresMap[g]),
  },
  {
